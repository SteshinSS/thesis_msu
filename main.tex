...
\end{itemize}
На выходе получается MID-вектор экспериментально измеренных метаболитов. Общая схема представлена на \ref{direct_simulation}.
...
\end{itemize} 
Конечно, обратная задача может иметь несколько решений, поэтому результат должен проанализироваться биологом. Схема на \ref{inverse_problem}. Формальное описание и решение модели в главе 2.
