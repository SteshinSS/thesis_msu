...
\begin{wraptable}{r}{0.4\linewidth}
	\begin{tabular}{c | c}
		\hline
		Меченность атомов & Вес молекулы\\ 
		\hline
		\rule{0pt}{4ex} \includegraphics{emus/000.png} & $m_0$\\
		\hline
		\rule{0pt}{4ex} \includegraphics{emus/001.png} & \\
		\rule{0pt}{4ex} \includegraphics{emus/010.png} & $m_0 + 1$\\
		\rule{0pt}{4ex} \includegraphics{emus/100.png} & \\
		\hline
		\rule{0pt}{4ex} \includegraphics{emus/011.png} & \\
		\rule{0pt}{4ex} \includegraphics{emus/101.png} & $m_0 + 2$\\
		\rule{0pt}{4ex} \includegraphics{emus/110.png} & \\
		\hline
		\rule{0pt}{4ex} \includegraphics{emus/111.png} & $m_0 + 3$\\
	\end{tabular}
