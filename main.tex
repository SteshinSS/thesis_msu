...
\emph{Стехиометрическая матрица} --- Матрица, каждый столбец которой соответствует химическому уравнению и заполнен коэффициентами метаболитов. При условии стационарности, при умножении на столбец скоростей метаболитов\todo{не так называется} даст ноль.

\clearpage

\section{Допущения}
Математическая модель для MFA основывается на нескольких допущениях о биологической системе\cite{Wiechert_1997_1}:\todo{Добавить метки}
\begin{enumerate}
